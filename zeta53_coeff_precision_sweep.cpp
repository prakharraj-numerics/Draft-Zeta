...
static constexpr int WORK_BITS=384, GEN_BITS=8192, REF_BITS=2048, MAXT=900, N=5000;
...
int main(){
 ...
 const double p[]={2.9,2.99,2.9999,std::nextafter(3.0,0.0),std::nextafter(3.0,INFINITY),3.0001,4.0,10.0,20.0,40.0,50.0,75.0,81.764554025359956,100.0,100.10072209666959,102.0};for(size_t i=0;i<sizeof(p)/sizeof(p[0]);i++)A[i]=p[i];
 ...
 const int CB[]={192,256,320,352,384,416,448,480,512,576,640,704,768,896,1024,1280,1536,2048};
