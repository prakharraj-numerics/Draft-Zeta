...
int main(){int W[]={106,128,160,192,224,256,288,320,352,384,448,512,640,768,1024};int nw=sizeof(W)/sizeof(W[0]);arb_poly_t s,z;arb_poly_init(s);arb_poly_init(z);arb_t one;arb_init(one);arb_one(one);arb_poly_set_coeff_si(s,0,-2);arb_poly_set_coeff_si(s,1,1);arb_poly_zeta_series(z,s,one,0,T1+1,GENPREC);
